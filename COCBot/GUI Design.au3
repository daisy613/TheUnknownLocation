...
GUICtrlCreateGroup("", -99, -99, 1, 1)
$AtkSpeed = GUICtrlCreateGroup("Attack Speed", 20, 170, 375, 85)
$lblUnitDelay = GUICtrlCreateLabel("Unit Delay:", 46, 210, 75, 17)
$lblWaveDelay = GUICtrlCreateLabel("Wave Delay:", 216, 210, 75, 17)
$cmbUnitDelay = GUICtrlCreateCombo("", 120, 206, 72, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
GUICtrlSetData(-1, "None|0.01 Sec|0.02 Secs|0.03 Secs|0.04 Secs|0.05 Secs|0.06 Secs|0.07 Secs|0.08 Secs|0.09 Secs|0.1 Sec", "0.05 Secs")
$cmbWaveDelay = GUICtrlCreateCombo("", 300, 206, 70, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
GUICtrlSetData(-1, "None|0.1 Sec|0.2 Secs|0.3 Secs|0.4 Secs|0.5 Secs|0.6 Secs|0.7 Secs|0.8 Secs|0.9 Secs|1 Sec", "0.5 Secs")
GUICtrlCreateGroup("", -99, -99, 1, 1)
$OtherBarrackSettings = GUICtrlCreateGroup("Other Settings", 20, 260, 375, 95)
$chkTrap = GUICtrlCreateCheckbox("Auto Rearm Traps", 35, 290, 115, 17)
$btnLocateTrap = GUICtrlCreateButton("Locate Trap Manually", 32, 315, 351, 25)

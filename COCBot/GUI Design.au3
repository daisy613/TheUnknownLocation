...
$Walls = GUICtrlCreateGroup("Walls", 20, 40, 380, 140)
$chkWalls = GUICtrlCreateCheckbox("Auto Walls Upgrade", 46, 60, 115, 17)
$usegold = GUICtrlCreateCheckbox("Use Only Gold", 46, 85, 115, 17)
$WallMinGold = GUICtrlCreateLabel("Minimum Gold: ", 216, 85, 76, 17)
$txtWallMinGold = GUICtrlCreateInput("1300000", 330, 85, 61, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 7)
$useelixir = GUICtrlCreateCheckbox("Use Only Elixir", 46, 110, 115, 17)
$WallMinElixir = GUICtrlCreateLabel("Minimum Elixir:", 216, 110, 72, 17)
$txtWallMinElixir = GUICtrlCreateInput("1300000", 330, 110, 61, 21, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
GUICtrlSetLimit(-1, 7)
$usegoldelix = GUICtrlCreateCheckbox("Use Both G and E", 46, 135, 115, 17)
$lblWalls = GUICtrlCreateLabel("Current Wall Level:", 216, 62, 115, 17)
$cmbWalls = GUICtrlCreateCombo("", 340, 58, 46, 21, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
